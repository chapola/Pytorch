...
class ResNet(nn.Module):  # [3,4,6,3]
    def __init__(self, block, layers, img_channels, num_classes):
        ...
        # self.layer1 =...
        # self.layers2 = ...
        self.layers1 = self._make_layer(block, layers[0], 64, stride=1)
        self.layers2 = self._make_layer(block, layers[1], 128, stride=2)
        self.layers3 = self._make_layer(block, layers[2], 256, stride=2)
        self.layers4 = self._make_layer(block, layers[3], 512, stride=2)
